...
impl LockedLogger {
    ...
    pub unsafe fn force_unlock(&self) { unsafe { self.0.force_unlock() }; }
}
...
impl Logger {
    ...
    fn add_vspace(&mut self, space: usize) { self.y_pos += space; }

    fn carriage_return(&mut self) { self.x_pos = 0; }
    ...
    fn width(&self) -> usize { self.info.horizontal_resolution }
